...
bool interfaces__msg__target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // is_enemy
    PyObject * field = PyObject_GetAttrString(_pymsg, "is_enemy");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->is_enemy = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * interfaces__msg__target__convert_to_py(void * raw_ros_message)
{
  ...
  {  // is_enemy
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->is_enemy ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "is_enemy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
