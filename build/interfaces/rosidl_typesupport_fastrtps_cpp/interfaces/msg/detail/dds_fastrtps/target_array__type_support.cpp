...
#include "interfaces/msg/detail/target_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::TargetArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::TargetArray & ros_message)
{
  // Member: targets
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: targets
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Target(
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::TargetArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::TargetArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::TargetArray *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_TargetArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, TargetArray)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_TargetArray__handle;
}
